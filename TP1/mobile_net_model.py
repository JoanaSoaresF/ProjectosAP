...
from keras.layers import GlobalAveragePooling2D, Conv2D, Activation, Dense
from tensorflow.keras.optimizers import Adam
from sklearn.model_selection import train_test_split

from TP1.multiclass_models import dense_block
from TP1.segmentation_model import up_block
...
def train_mobile_net_model(X, Y, test_x, test_classes, now):
    """
    ...
    """
    log_dir = "{}/MobileNet{}/".format(root_logdir, now)
    ...
    model = create_mobile_net_model((64, 64, 3))
    ...
    model.save_weights('pesos/mobile_net_model{}.h5'.format(now))
